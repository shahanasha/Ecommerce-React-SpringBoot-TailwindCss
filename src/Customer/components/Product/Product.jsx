...
export default function Product() {
    ...
    const decodedQuesryString = decodeURIComponent(location.search);
    const searchParams = new URLSearchParams(decodedQuesryString);
    ...
    const hadleRadioFilterChange = (e, sectionId) => {
        const searchParams = new URLSearchParams(location.search)
                                                        ...
                                                        <div className="space-y-4">
                                                            <FormControl>
                                                                ...
                                                                >
                                                                    {section.options.map((option, optionIdx) => (
                                                                        <>
                                                                            <FormControlLabel onChange={(e) => hadleRadioFilterChange(e, section.id)} value={option.value} control={<Radio />} label={option.label} />
